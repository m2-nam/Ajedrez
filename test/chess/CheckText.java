...
public class CheckText {
	...
	public void testCheck1() {
		...
		board[0][5] = new Rook(SideColor.PINK , 0, 5);
	...
	public void testCheck2() {
		Chessman board[][] = new Chessman[8][8];
		board[1][6] = new King(SideColor.PINK , 1 ,6);
		board[6][1] = new Bishop(SideColor.BLACK , 6, 1);
		
		assertEquals(GamePanel.check(board , SideColor.PINK), true);
	...
	public void testCheck3() {
		Chessman board[][] = new Chessman[8][8];
		board[5][5] = new King(SideColor.PINK , 4 ,5);
		board[3][5] = new Pawn(SideColor.BLACK , 3, 5);
		
		assertEquals(GamePanel.check(board , SideColor.PINK), false);
	...
	public void testCheck4() {
		...
		board[5][5] = new Pawn(SideColor.PINK , 5, 5);
		board[2][3] = new King(SideColor.PINK , 2 ,2);
