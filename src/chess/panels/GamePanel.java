...
public abstract class GamePanel extends JPanel{
	...
	private void drawBoard()
	{
		...
		g.setColor(Color.decode("#ffd4e9"));
	...
	private void generatePieces() {
		...
		for(int i=0 ; i<8 ; i++) {
			piecesBoard[i][6] =new Pawn(SideColor.PINK ,i ,6);;
			piecesBoard[i][1] =new Pawn(SideColor.BLACK ,i ,1);
		}
		
		piecesBoard[0][7] = new Rook(SideColor.PINK, 0, 7);
		piecesBoard[7][7] = new Rook(SideColor.PINK, 7, 7);
		piecesBoard[0][0] = new Rook(SideColor.BLACK, 0, 0);
		piecesBoard[7][0] = new Rook(SideColor.BLACK, 7, 0);
		
		piecesBoard[1][7] = new Knight(SideColor.PINK, 1, 7);
		piecesBoard[6][7] = new Knight(SideColor.PINK, 6, 7);
		piecesBoard[1][0] = new Knight(SideColor.BLACK, 1, 0);
		piecesBoard[6][0] = new Knight(SideColor.BLACK, 6, 0);
		
		piecesBoard[2][7] = new Bishop(SideColor.PINK, 2, 7);
		piecesBoard[5][7] = new Bishop(SideColor.PINK, 5, 7);
		piecesBoard[2][0] = new Bishop(SideColor.BLACK, 2, 0);
		piecesBoard[5][0] = new Bishop(SideColor.BLACK, 5, 0);	
		
		piecesBoard[3][7] = new Queen(SideColor.PINK, 3, 7);
		piecesBoard[3][0] = new Queen(SideColor.BLACK, 3, 0);
		
		piecesBoard[4][7] = new King(SideColor.PINK, 4, 7);
		 ...
		 addMouseListener(new MouseAdapter(){ 
	         public void mousePressed(MouseEvent me) { 
	        	 ...
	        	 if((piecesBoard[tempX][tempY]==null && selected==null) || !enabled) return;
	            	 ...
	            	 if(selected.color==SideColor.PINK && !whiteMove) {
	            		 selected=null;
	            		 return;
	            	 }
	...
	public void checkmate(SideColor col , Chessman[][] board) {
		...
		if(any.isEmpty()) {
			...
			possibleMoves.clear();
			repaint();
			JOptionPane.showMessageDialog(null,col.getBetterString() +" Rey es Jaque Mate. "+col.swapColor().getBetterString()+
					"s Gana. " ,
	...
	public void checkStalemate(SideColor col , Chessman[][] board) {
		...
		if(any.isEmpty()) {
			possibleMoves.clear();
			repaint();
			JOptionPane.showMessageDialog(null,col.getBetterString() +"s no tiene movimientos disponibles. El juego termina con un empate. " ,
					"Estancamiento",JOptionPane.INFORMATION_MESSAGE);
			closeFrame();
